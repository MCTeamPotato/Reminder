...
public class RemindConfig {
    ...
    static {
        ...
        WEEKLY_ACTIVITIES = builder.comment("Weekly activities in format WEEKDAY:HH:MM:SS->activityLangKey", "Example: 1:08:00:00->info.time.to.getup.for.class").defineListAllowEmpty("WeeklyActivities", Lists.newArrayList(), () -> "WEEKDAY:HH:MM:SS->activityLangKey", alwaysTrue);
